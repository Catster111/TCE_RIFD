...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--arch', default='light_hybrid_pretrain',
                             help='model architecture. Currently tested'
                                  'res_18 | res_101 | resdcn_18 | resdcn_101 |'
                                  'dlav0_34 | dla_34 | hourglass | mobilev2_10')
    ...
    self.parser.add_argument('--lr', type=float, default=.5e-3,
                             help='learning rate for batch size 32.')
    self.parser.add_argument('--lr_step', type=str, default='60,70,100',  #这个地方的目的就是epoch调整学习率
                             help='drop learning rate by 10.')
    self.parser.add_argument('--num_epochs', type=int, default=500, #这个地方就是修改epoch的轮次
                             help='total training epochs.')
    self.parser.add_argument('--batch_size', type=int, default=4,
                             help='batch size')
    self.parser.add_argument('--master_batch_size', type=int, default=4,
    ...
    self.parser.add_argument('--test_scales', type=str, default=
                             '1',
    ...
    self.parser.add_argument('--hm_hp_weight', type=float, default=0.1,
    ...
    # Custom argument for rotation angle
    self.parser.add_argument('--angle', type=int, required=False, help='Rotation angle (0, 30, 60, ..., 360)')
    self.parser.add_argument('--output_dir', type=int, required=False, help='Rotation angle (0, 30, 60, ..., 360)')
  ...
  def parse(self, args=''):
    ...
    #opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task) #保存模型地址
    opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task,'Hathai_25_04_2025_version1')   #这个地方就是修改模型的存储位置的
